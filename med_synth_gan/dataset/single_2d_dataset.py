...
class SingleVolume2DDataset(Dataset):
    def __init__(self, volume_path, slice_axis=2):
        ...
        self.volume = volume_nifti.get_fdata(dtype=np.float32)
        ...
        self.orig_h, self.orig_w = self.slices[0].shape
        self.target_size = 256
        self.scale_factors = (self.orig_h / self.target_size, self.orig_w / self.target_size)
